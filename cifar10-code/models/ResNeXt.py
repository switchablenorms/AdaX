...
class ResNeXt(nn.Module):
    ...
    """
    def __init__(self, baseWidth, cardinality, block=Bottleneck, layers=None, num_classes=1000, zero_init_residual=False):
        """ Constructor
        Args:
...
def resnext50(baseWidth, cardinality, **unused):
    """
    Construct ResNeXt-50.
    """
    model = ResNeXt(baseWidth, cardinality, Bottleneck, [3, 4, 6, 3], 1000)
    return model


def resnext101(baseWidth, cardinality, **unused):
    """
    Construct ResNeXt-101.
    """
    model = ResNeXt(baseWidth, cardinality, Bottleneck, [3, 4, 23, 3], 1000)
    return model


def resnext152(baseWidth, cardinality, **unused):
    """
    Construct ResNeXt-152.
    """
    model = ResNeXt(baseWidth, cardinality, Bottleneck, [3, 8, 36, 3], 1000)
    return model
